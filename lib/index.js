...
var method_add    = require('./method.add.js');
var method_remove = require('./method.remove.js');
var method_append = require('./method.append.js');
var method_front  = require('./method.front.js');
...
module.exports = {
  ...
  add    : method_add(client),
  remove : method_remove(client),
  append : method_append(client),
  front  : method_front(client)
};
